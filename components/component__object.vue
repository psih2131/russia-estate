<template>
    ...
    <div class="object-element">
        <div class="object-element__img-wrapper">
            <img src="@/assets/images/object-img-1.jpg" alt="" class="object-element__img">
        ...
        <div class="object-element__body">
            <div class="object-element__body-top">
                <p class="object-element__title">
                    <a href="" class="object-element__title-link">ЖК «Элитный квартал Тишинский бульвар»</a>
                </p>
                <div class="object-element__location-row">
                    <div class="object-element__location">
                        ...
                        <p class="object-element__location-text">Нагатинская набережная, вл. 10, Москва</p>
                    </div>

                    <button class="object-element__location-btn btn-v1-small">Показать на карте</button>
                </div>

                <p class="object-element__short-description">«Тишинский бульвар» — тихий зелёный элитный квартал на Тишинке, в престижном и комфортном районе центра Москвы. В нём создан уникальный для элитного дома прогулочный бульвар в огромном дворе-парке 2,1 га. Во дворе оборудованы</p>
            </div>

            <div class="object-element__body-down">
                <div class="object-element__info-row">
                    <div class="object-element__info-element">
                        от <b>7 500 000 <span>₽</span></b>
                    </div>

                    <div class="object-element__info-element">
                        от <b>24</b> кв<span>²</span> до <b>78</b> кв<span>²</span>
                    </div>
                ...
                <div class="object-element__button-row">
                    <a href="" class="object-element__btn-view-object btn-v1">Ознакомиться с обьектом</a>
                    <a href="" class="object-element__developer-big-card">
