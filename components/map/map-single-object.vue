...
watch(
  ...
  (newVal) => {
    if (newVal?.acf) {
        yMapCenterCordinats.value.lon = props.yMapObjetList[0].acf.dolgota;
        yMapCenterCordinats.value.lat = props.yMapObjetList[0].acf.shirota;
        console.log('map current lng log',props.yMapObjetList[0].acf.shirotayMapObjetList[0].acf.dolgota)
    }
  },
  { immediate: true }
)
...
onMounted(() => {
  // Добавляем обработчик события scroll
     yMapCenterCordinats.value.lon = +props.yMapObjetList[0].acf.dolgota + 0.015;
        yMapCenterCordinats.value.lat = props.yMapObjetList[0].acf.shirota;
        console.log('map current lng log',props.yMapObjetList[0])
